    ...
    <AdminLayout>
      <div className=''>
        ...
        <div className='text-sm flex justify-end p-4 '>
          <button
            className='rounded-xl shadow-sm px-4 py-2.5 bg-lime-600 text-white
           hover:bg-lime-800 transition-colors duration-200 font-medium flex items-center gap-2' onClick={handleOpenModal}>
            <Plus size={16} />
            Add User
          </button>
        </div>
